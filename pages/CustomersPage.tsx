...
const CustomersPage: React.FC = () => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            alert("Failed to delete customer: " + (error?.message || "This customer may have associated records."));
        } finally {
            setDeleting(false);
        }
    };
    ...
    return (
        <div className="space-y-8 animate-fade-in-up pb-10">
            ...
            {deleteConfirm && (
                <Modal isOpen={true} title="Delete Customer" onClose={() => setDeleteConfirm(null)} maxWidth="max-w-md">
                    <div className="text-center py-4">
                        ...
                        <h3 className="text-lg font-bold text-slate-800 dark:text-white mb-2">Delete "{deleteConfirm.companyName}"?</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
                            This action cannot be undone. All data associated with this customer may also be deleted.
                        </p>
                        <div className="flex gap-3 justify-center">
                            ...
                            <button
                                ...
                                disabled={deleting}
                                className="px-5 py-2.5 bg-red-500 text-white font-bold rounded-xl hover:bg-red-600 transition-colors shadow-lg shadow-red-500/30 disabled:opacity-50 flex items-center gap-2"
                            >
                                {deleting ? (
                                    <>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="text-slate-400 hover:text-primary-600 dark:hover:text-primary-400 bg-transparent hover:bg-primary-50 dark:hover:bg-primary-900/20 p-2 rounded-lg transition-all"
                                                title="Edit Customer"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="text-slate-400 hover:text-red-600 dark:hover:text-red-400 bg-transparent hover:bg-red-50 dark:hover:bg-red-900/20 p-2 rounded-lg transition-all"
